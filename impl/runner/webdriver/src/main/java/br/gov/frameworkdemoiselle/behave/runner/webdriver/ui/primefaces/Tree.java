...
/**
 * Componente para mapear elementos de tela referentes ao componente Primefaces Tree
 * 
 * Utiliza a API Javascript do Primefaces para a correta manipulação do componente. O locator do mapeamento de tela deve retornar o primeiro div gerado pelo componente rich:calendar, aquele div que possui 'class="ui-tree"'
 * 
 * @author lmveloso
 * 
 */
...
public class Tree extends WebBase {
	...
	/**
	 * Verifica se o componente selecionado é realmente um coponente PrimeFaces Tree
	 * 
	 * @return
	 */
