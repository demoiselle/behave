...
public class WebAutoComplete extends WebBase implements AutoComplete {
	...
	/**
	 * Armazena o valor que será selecionado na lista
	 * do autocomplete, somente se, o valor de busca
	 * for diferente deste
	 * 
	 * Exemplo: Busca pelo texto "foo" mas seleciona
	 * na lista o valor "foo, bar"
	 * 
	 * @see #select(String)
	 */
	...
	protected void select(String value) {
		 ...
		 *  	 com versões anteriores do DBehave (1.3.0 por exemplo) 
		 */
		try{
