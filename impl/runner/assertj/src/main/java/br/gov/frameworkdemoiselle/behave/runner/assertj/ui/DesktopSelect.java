...
public class DesktopSelect extends DesktopBase implements Select {
	private static BehaveMessage message = new BehaveMessage(AssertJRunner.MESSAGEBUNDLE);
	...
	public String getText() {
		...
		if (comboFixture.target() != null && comboFixture.target().getSelectedItem() != null)
			return comboFixture.target().getSelectedItem().toString();
		return null;
	}
