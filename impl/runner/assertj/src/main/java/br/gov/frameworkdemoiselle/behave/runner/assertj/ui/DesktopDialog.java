...
public class DesktopDialog extends DesktopBase implements Dialog {
	...
	public void accept() {
		...
		DialogFixture dialogFixture = dialogFinder.using(((AssertJRunner) runner).robot);
		java.awt.Dialog dialog = dialogFixture.target();
	...
	public void sendKeys(String keys) {
		...
		throw new BehaveException(
				coreMessage.getString("exception-method-not-implemented", "DesktopDialog.sendKeys(String keys)"));
	}
	...
	private static class DialogTitleMatcher extends GenericTypeMatcher<java.awt.Dialog> {
		...
		public String toString() {
			return Strings.concat(DialogTitleMatcher.class.getSimpleName(), "(", Strings.quote(matchString), ")");
		}
	}
	...
	private static class JButtonTextMatcher extends GenericTypeMatcher<JButton> {
		...
		@Override
		public String toString() {
			return Strings.concat(JButtonTextMatcher.class.getSimpleName(), "(", Strings.quote(matchString), ")");
		}
	}
}