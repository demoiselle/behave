 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://open-services.net/ns/qm#}TestPlan"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "reportsOnTestPlan")
public class ReportsOnTestPlan {

    @XmlElement(name = "TestPlan", required = true)
