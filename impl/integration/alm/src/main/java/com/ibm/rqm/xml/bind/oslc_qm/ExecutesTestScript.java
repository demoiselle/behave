 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://open-services.net/ns/qm#}TestScript"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "executesTestScript")
public class ExecutesTestScript {

    @XmlElement(name = "TestScript", required = true)
