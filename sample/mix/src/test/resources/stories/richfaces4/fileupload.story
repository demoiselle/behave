...
Desejo usar o componente FileUpload
...
!-- Então no "FileUpload" o estado do arquivo "testes-2.jpg" será "File size is exceeded" !-- Existe um problema no componente no site demonstração!
