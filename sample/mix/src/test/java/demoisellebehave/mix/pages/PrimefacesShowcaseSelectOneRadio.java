...
public class PrimefacesShowcaseSelectOneRadio {
	...
	@ElementMap(name = "Primefaces SelectOneRadio Basic - Console - First Option", locatorType = ElementLocatorType.XPath, locator = { "//form/table[1]/tbody/tr/td/table/tbody/tr/td[1]/div/div[2]", "//form/table[1]/tbody/tr/td/table/tbody/tr/td[1]/div[1]/div[1]/input[@type='radio']" })
