...
import br.gov.frameworkdemoiselle.behave.runner.webdriver.ui.primefaces.PrimeFacesTree;
...
public class MySteps extends CommonSteps {
	...
	public void thenExpandNodeByLabel(String label, String elementName) {
		PrimeFacesTree element = (PrimeFacesTree) runner.getElement(currentPageName, elementName);
