 ...
 */
package demoisellebehave.sample.dbehavesite.regression.test;
...
public class RegressionTest {
	...
	public void test() throws Throwable {
		...
		// Adiciona a história para rodar nos navegadores
		eng.addStoriesGlobal("/stories/");
		
		// Adiciona os passos para as execuções
		eng.addStepsGlobal(new RegressionSteps());
